...
public class Globals {
    ...
    public readonly static string CLIENT_SECRET = Environment.GetEnvironmentVariable("MC_CLIENT_SECRET")!;
    public readonly static string SUBDOMAIN = Environment.GetEnvironmentVariable("MC_SUBDOMAIN")!;
